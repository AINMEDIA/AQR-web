            ...
            <div className="grid grid-cols-2 gap-4 md:gap-8">
              ...
              <div className="bg-white rounded-xl md:rounded-2xl p-4 md:p-6 shadow-xl border-2 border-blue-200 flex flex-col items-center justify-start text-center" data-aos="zoom-in" data-aos-delay="200">
                ...
                <div className="w-full mt-4 md:mt-6">
                  <Link href="/services/tours/visa/application" className="w-full px-6 py-3 bg-blue bg-blue-700 text-white font-bold rounded-full shadow-lg hover:bg-blue-800 hover:text-white transition-all duration-500 text-base hover:scale-105 hover:shadow-xl flex items-center justify-center gap-2 group">
                    Apply for Visa
