  ...
  return (
    <PageTransition>
      <div className="max-w-2xl mx-auto py-12 px-4 animate-fade-in">
        <h1 className="text-3xl font-bold mb-6 flex items-center gap-2 text-yellow-800"><Car className="w-7 h-7 text-yellow-500 " /> Luxury Car Hire</h1>
