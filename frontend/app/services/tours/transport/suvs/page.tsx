...
export default function SUVsCarHirePage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // WhatsApp API link (send to both numbers)
    ...
    <PageTransition>
      <div className="animate-fade-in max-w-xl mx-auto py-16 px-4">
        <h1 className="text-4xl font-bold mb-6 flex items-center gap-2 text-blue-700">
          <Car className="w-8 h-8 text-blue-500" /> SUVs Car Hire Request
        </h1>
