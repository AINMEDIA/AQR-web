            ...
            <section className="my-12 p-8 bg-blue-50 rounded-2xl shadow-md animate-fade-in-up" data-aos="fade-up" data-aos-delay="250">
              ...
              <div className="max-w-4xl mx-auto text-center animate-fade-in" data-aos="fade-up" data-aos-delay="200">
                <blockquote className="text-xl md:text-3xl font-bold text-blue-800 leading-relaxed mb-8 italic">
                  At AQR, we unlock doors to dignified opportunities and life-changing adventures — guided by trust, integrity, and excellence.
                </blockquote>
                ...
                <p className="text-lg md:text-2xl text-blue-700 leading-relaxed font-medium">
                  We believe that work and travel should elevate your life, not just fill your time. Whether you're seeking meaningful employment abroad or unforgettable journeys, AQR is your <span className="font-bold text-blue-800">trusted partner</span> every step of the way.
                </p>
              </div>
